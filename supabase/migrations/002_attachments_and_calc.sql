...
-- Reviews (committee/admin comments, actions)
...
-- Automatic reimbursement calculation logic
...
begin
  ...
  -- Get membership type and limits
...
-- Trigger to run compute_claim_payable when claims or items change
